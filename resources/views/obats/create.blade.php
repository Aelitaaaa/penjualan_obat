    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('obats.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" class="form-control" id="harga_obat" name="harga_obat" required>
            </div>
            <div class="mb-3">
                <label for="jumlah_obat" class="form-label">Jumlah Obat</label>
                <input type="number" class="form-control" id="jumlah_obat" name="jumlah_obat" required>
            </div>
